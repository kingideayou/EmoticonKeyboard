...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (pager.getAdapter() instanceof IconTabProvider) {
				...
				addTextTab(i, pager.getAdapter().getPageTitle(i) == null ? "" : pager.getAdapter().getPageTitle(i).toString());
			}
	...
	protected void onDraw(Canvas canvas) {
        ...
        Log.e("PagerSlidingTabStrip", "currentPositionOffset : " + currentPositionOffset);
        Log.e("PagerSlidingTabStrip", "currentPosition : " + currentPosition);
        Log.e("PagerSlidingTabStrip", "tabCount : " + tabCount);
